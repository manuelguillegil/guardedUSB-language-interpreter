...
##Fecha de modificación: 05-10-2019, 09:00 Hora de Venezuela

#Comentarios generales: Antlr es muy complicado para aprender en una semana. Viva Python y Ply

#Últimas modificaciones: Añadí las últimas palabras reservadas que faltaban. Arreglé el output del print en el tokeneizer
#
...
while True:
    ...
    if tok.type == 'TkId':
        ...
        print('%s %d %d ' % (tok.type, tok.lineno, tok.lexpos))