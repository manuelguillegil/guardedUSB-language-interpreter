...
class Node:
    ...
    def findValue(self):
        if (self.category == "Literal" or self.category == "Ident"):
            print('self.expresionValue1: ' + str(self.expresionValue))
            self.expresionValue = self.expresionValue + str(self.value)
            print('self.expresionValue2: ' + str(self.expresionValue))
